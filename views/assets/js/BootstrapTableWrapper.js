class BootstrapTableWrapper {
    ...
    showEditNoteModal(data) {
        ...
        dlg.open({
            type: "order",
            noteId: 0,
            orderId: MODULE_MPNOTES.orderId,
            customerId: MODULE_MPNOTES.customerId,
            customerName: MODULE_MPNOTES.customerName,
            employeeId: MODULE_MPNOTES.employeeId,
            employeeName: MODULE_MPNOTES.employeeName,
            content: "",
            printable: 0,
            chat: 0,
        });
